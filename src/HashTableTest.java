...
public class HashTableTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    try {
      ...
      record1Handle =
        memManager.insert(record1_serialized, record1_serialized.length);
      ...
      record2Handle =
        memManager.insert(record2_serialized, record2_serialized.length);
      ...
      record3 =
        ...
        record4Handle =
            memManager.insert(record4_serialized, record4_serialized.length);
